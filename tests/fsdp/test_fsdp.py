...
from transformers_471.trainer_callback import TrainerState
from transformers_471.trainer_utils import FSDPOption, set_seed
...
if is_torch_available():
    from transformers_471.trainer import FSDP_MODEL_NAME
