...
from transformers_471 import AutoModelForCausalLM, PretrainedConfig, set_seed
from transformers_471.models.auto.auto_factory import getattribute_from_module
