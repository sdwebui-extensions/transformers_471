...
from transformers_471 import AutoConfig, AutoModelForCausalLM, AutoTokenizer, QuantoConfig
...
from transformers_471.utils import is_accelerate_available, is_optimum_quanto_available, is_torch_available


if is_torch_available():
    import torch

    from transformers_471 import LlamaForCausalLM
...
if is_optimum_quanto_available():
    ...
    from transformers_471.integrations.quanto import replace_with_quanto_layers
...
class QuantoQuantizationTest(unittest.TestCase):
    ...
    def test_load_from_quanto_saved(self):
        ...
        from transformers_471 import QuantoConfig
