...
from transformers_471 import AutoConfig, AutoModelForCausalLM, AutoTokenizer, GPTQConfig
...
from transformers_471.utils import is_auto_gptq_available, is_gptqmodel_available, is_ipex_available
