...
from transformers_471.pipelines import DocumentQuestionAnsweringPipeline, pipeline
from transformers_471.pipelines.document_question_answering import apply_tesseract
