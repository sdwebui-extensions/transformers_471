...
from transformers_471 import MODEL_FOR_VISUAL_QUESTION_ANSWERING_MAPPING, is_vision_available
from transformers_471.pipelines import pipeline
...
if is_torch_available():
    ...
    from transformers_471.pipelines.pt_utils import KeyDataset
