...
from transformers_471 import MODEL_FOR_DEPTH_ESTIMATION_MAPPING, is_torch_available, is_vision_available
from transformers_471.pipelines import DepthEstimationPipeline, pipeline
