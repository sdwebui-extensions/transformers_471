...
from transformers_471 import Speech2TextFeatureExtractor
from transformers_471.testing_utils import check_json_file_has_correct_format, require_torch, require_torchaudio
...
class Speech2TextFeatureExtractionWithoutTorchaudioTest(Speech2TextFeatureExtractionTest):
    def test_using_audio_utils(self):
        ...
        from transformers_471.models.speech_to_text.feature_extraction_speech_to_text import is_speech_available
