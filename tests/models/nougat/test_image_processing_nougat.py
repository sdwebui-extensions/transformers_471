...
from transformers_471.image_utils import SizeDict, load_image
...
if is_vision_available():
    ...
    from transformers_471 import NougatImageProcessor

    if is_torchvision_available():
        from transformers_471 import NougatImageProcessorFast
