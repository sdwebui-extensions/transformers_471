...
from transformers_471 import SamConfig, SamMaskDecoderConfig, SamPromptEncoderConfig, SamVisionConfig, pipeline
...
if is_torch_available():
    ...
    from transformers_471 import SamModel, SamProcessor, SamVisionModel
