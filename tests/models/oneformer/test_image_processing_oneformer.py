...
if is_torch_available():
    ...
    if is_vision_available():
        from transformers_471 import OneFormerImageProcessor

    if is_torchvision_available():
        from transformers_471 import OneFormerImageProcessorFast
        from transformers_471.models.oneformer.image_processing_oneformer import binary_mask_to_rle, prepare_metadata
