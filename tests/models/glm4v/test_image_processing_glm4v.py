...
if is_vision_available():
    ...
    from transformers_471 import Glm4vImageProcessor
    from transformers_471.models.glm4v.image_processing_glm4v import smart_resize

    if is_torchvision_available():
        from transformers_471 import Glm4vImageProcessorFast
