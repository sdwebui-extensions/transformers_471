...
from transformers_471.models.efficientloftr import EfficientLoFTRConfig, EfficientLoFTRModel
...
if is_torch_available():
    ...
    from transformers_471 import EfficientLoFTRForKeypointMatching
