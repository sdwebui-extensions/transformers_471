...
from transformers_471 import AutoTokenizer, GraniteMoeSharedConfig, is_torch_available, set_seed
...
if is_torch_available():
    ...
    from transformers_471.models.granitemoeshared.modeling_granitemoeshared import (
