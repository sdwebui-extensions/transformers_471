...
from transformers_471.testing_utils import Expectations, require_torch, slow, torch_device
...
if is_torch_available():
    ...
    from transformers_471 import MODEL_MAPPING, PoolFormerConfig, PoolFormerForImageClassification, PoolFormerModel
