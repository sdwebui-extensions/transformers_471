...
from transformers_471 import DPRConfig, is_torch_available
...
if is_torch_available():
    ...
    from transformers_471 import DPRContextEncoder, DPRQuestionEncoder, DPRReader, DPRReaderTokenizer
