...
from transformers_471 import DacFeatureExtractor
...
@require_torch
# Copied from transformers_471.tests.encodec.test_feature_extraction_dac.EncodecFeatureExtractionTester with Encodec->Dac
...
@require_torch
# Copied from transformers_471.tests.encodec.test_feature_extraction_dac.EnCodecFeatureExtractionTest with Encodec->Dac
