...
from transformers_471 import T5Tokenizer, T5TokenizerFast
from transformers_471.testing_utils import require_sentencepiece, require_torch
from transformers_471.utils.import_utils import is_speech_available


if is_speech_available():
    from transformers_471 import EncodecFeatureExtractor, MusicgenProcessor
