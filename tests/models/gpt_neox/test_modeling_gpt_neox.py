...
from transformers_471 import AutoTokenizer, DynamicCache, GPTNeoXConfig, is_torch_available, set_seed
...
if is_torch_available():
    ...
    from transformers_471.models.gpt_neox.modeling_gpt_neox import GPTNeoXRotaryEmbedding
