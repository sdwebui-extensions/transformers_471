...
from transformers_471 import SeamlessM4TFeatureExtractor, is_speech_available
from transformers_471.testing_utils import check_json_file_has_correct_format, require_torch
