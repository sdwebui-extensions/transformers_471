...
from transformers_471.testing_utils import require_torch, require_torch_gpu, require_vision, slow, torch_device
...
if is_vision_available():
    ...
    from transformers_471 import PixtralImageProcessor

    if is_torchvision_available():
        from transformers_471 import PixtralImageProcessorFast
