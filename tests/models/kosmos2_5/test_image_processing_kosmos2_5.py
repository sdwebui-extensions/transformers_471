...
from transformers_471.testing_utils import require_torch, require_torch_accelerator, require_vision, slow, torch_device
...
if is_vision_available():
    ...
    from transformers_471 import Kosmos2_5ImageProcessor

    if is_torchvision_available():
        from transformers_471 import Kosmos2_5ImageProcessorFast
