...
from transformers_471.utils.import_utils import is_torchaudio_available


if is_torchaudio_available():
    from transformers_471 import MusicgenMelodyFeatureExtractor, MusicgenMelodyProcessor
