...
from transformers_471 import AutoTokenizer, DeepseekV3Config, is_torch_available, set_seed
...
if is_torch_available():
    ...
    from transformers_471.models.deepseek_v3.modeling_deepseek_v3 import (
