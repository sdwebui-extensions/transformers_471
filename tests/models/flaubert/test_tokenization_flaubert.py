...
from transformers_471 import FlaubertTokenizer
from transformers_471.models.flaubert.tokenization_flaubert import VOCAB_FILES_NAMES
from transformers_471.testing_utils import slow
...
class FlaubertTokenizationTest(TokenizerTesterMixin, unittest.TestCase):
    ...
    # Copied from transformers_471.tests.models.xlm.test_tokenization_xlm.XLMTokenizationTest.test_full_tokenizer
    ...
    @slow
    # Copied from transformers_471.tests.models.xlm.test_tokenization_xlm.XLMTokenizationTest.test_sequence_builders
