...
from transformers_471 import Data2VecAudioConfig, is_torch_available
...
if is_torch_available():
    ...
    from transformers_471.models.data2vec.modeling_data2vec_audio import _compute_mask_indices
