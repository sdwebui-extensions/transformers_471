...
from transformers_471 import AutoBackbone
from transformers_471.testing_utils import require_timm, require_torch, torch_device
...
if is_torch_available():
    from transformers_471 import TimmBackbone, TimmBackboneConfig
