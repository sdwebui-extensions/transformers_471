...
from transformers_471 import ClvpFeatureExtractor
...
# Copied from transformers_471.tests.models.whisper.test_feature_extraction_whisper.floats_list
...
class ClvpFeatureExtractionTester:
    ...
    # Copied from transformers_471.tests.models.whisper.test_feature_extraction_whisper.WhisperFeatureExtractionTester.prepare_inputs_for_common
...
class ClvpFeatureExtractionTest(SequenceFeatureExtractionTestMixin, unittest.TestCase):
    ...
    # Copied from transformers_471.tests.models.whisper.test_feature_extraction_whisper.WhisperFeatureExtractionTest.test_feat_extract_from_and_save_pretrained
    ...
    # Copied from transformers_471.tests.models.whisper.test_feature_extraction_whisper.WhisperFeatureExtractionTest.test_feat_extract_to_json_file
    ...
    # Copied from transformers_471.tests.models.whisper.test_feature_extraction_whisper.WhisperFeatureExtractionTest.test_double_precision_pad
