...
from transformers_471 import AltCLIPConfig, AltCLIPProcessor, AltCLIPTextConfig, AltCLIPVisionConfig
...
if is_torch_available():
    ...
    from transformers_471 import AltCLIPModel, AltCLIPTextModel, AltCLIPVisionModel
