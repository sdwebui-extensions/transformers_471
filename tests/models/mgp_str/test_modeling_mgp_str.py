...
from transformers_471 import MgpstrConfig
...
if is_torch_available():
    ...
    from transformers_471 import MgpstrForSceneTextRecognition, MgpstrModel


if is_vision_available():
    from PIL import Image

    from transformers_471 import MgpstrProcessor
