...
from transformers_471 import Owlv2Config, Owlv2TextConfig, Owlv2VisionConfig
...
if is_torch_available():
    ...
    from transformers_471 import Owlv2ForObjectDetection, Owlv2Model, Owlv2TextModel, Owlv2VisionModel
