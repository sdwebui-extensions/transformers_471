...
from transformers_471 import AutoTokenizer, GraniteMoeConfig, is_torch_available, set_seed
...
if is_torch_available():
    ...
    from transformers_471.models.granitemoe.modeling_granitemoe import (
