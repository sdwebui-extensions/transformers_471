...
from transformers_471 import DetrConfig, ResNetConfig, is_torch_available, is_vision_available
...
if is_torch_available():
    ...
    from transformers_471 import DetrForObjectDetection, DetrForSegmentation, DetrModel
