...
from transformers_471 import MobileViTConfig
...
if is_torch_available():
    ...
    from transformers_471 import MobileViTForImageClassification, MobileViTForSemanticSegmentation, MobileViTModel
