...
from transformers_471.testing_utils import run_test_using_subprocess
from transformers_471.utils.import_utils import clear_import_cache
...
def test_clear_import_cache():
    ...
    from transformers_471.models.auto import modeling_auto
