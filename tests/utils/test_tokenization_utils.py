...
from transformers_471.testing_utils import TOKEN, TemporaryHubRepo, is_staging_test, require_tokenizers
from transformers_471.tokenization_utils import ExtensionsTrie, Trie
