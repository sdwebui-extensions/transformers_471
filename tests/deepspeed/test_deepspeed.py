...
from transformers_471 import AutoModel, TrainingArguments, is_torch_available, logging
...
from transformers_471.trainer_utils import get_last_checkpoint, set_seed
from transformers_471.utils import SAFE_WEIGHTS_NAME, is_torch_bf16_available_on_device, is_torch_fp16_available_on_device
...
if is_deepspeed_available():
    ...
    from transformers_471.integrations.deepspeed import deepspeed_config, is_deepspeed_zero3_enabled  # noqa
...
class CoreIntegrationDeepSpeed(TestCasePlus, TrainerIntegrationCommon):
    ...
    def test_init_zero3_missing_params(self):
        ...
        from transformers_471.models.gpt2.modeling_gpt2 import GPT2PreTrainedModel
...
class TrainerIntegrationDeepSpeed(TrainerIntegrationDeepSpeedWithCustomConfig, TrainerIntegrationCommon):
    ...
    #     from transformers_471 import Trainer  # noqa
    ...
    def test_load_best_model(self, stage, dtype):
        ...
        from transformers_471 import T5ForConditionalGeneration, T5Tokenizer, Trainer  # noqa
