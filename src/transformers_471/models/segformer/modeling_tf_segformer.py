...
# Copied from transformers_471.models.convnext.modeling_tf_convnext.TFConvNextDropPath with ConvNext->Segformer
...
class TFSegformerForSemanticSegmentation(TFSegformerPreTrainedModel):
    ...
    def call(
        ...
        ```python
        >>> from transformers_471 import AutoImageProcessor, TFSegformerForSemanticSegmentation
