...
class DPTImageProcessor(BaseImageProcessor):
    ...
    # Copied from transformers_471.models.beit.image_processing_beit.BeitImageProcessor.__call__
    ...
    # Copied from transformers_471.models.beit.image_processing_beit.BeitImageProcessor.post_process_semantic_segmentation with Beit->DPT
