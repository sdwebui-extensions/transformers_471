...
class SiglipTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_471 import SiglipTextConfig, SiglipTextModel
...
class SiglipConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_471 import SiglipConfig, SiglipModel
    ...
    >>> from transformers_471 import SiglipTextConfig, SiglipVisionConfig
