...
# Copied from transformers_471.models.llama.modeling_llama.LlamaRMSNorm with Llama->JetMoe
...
# Copied from transformers_471.models.gemma.modeling_gemma.GemmaRotaryEmbedding with Gemma->JetMoe
