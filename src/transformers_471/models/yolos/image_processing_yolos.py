...
# Copied from transformers_471.models.detr.image_processing_detr.prepare_coco_detection_annotation
...
# Copied from transformers_471.models.detr.image_processing_detr.prepare_coco_panoptic_annotation with DETR->YOLOS
...
class YolosImageProcessor(BaseImageProcessor):
    ...
    @classmethod
    # Copied from transformers_471.models.detr.image_processing_detr.DetrImageProcessor.from_dict with Detr->Yolos
    ...
    # Copied from transformers_471.models.detr.image_processing_detr.DetrImageProcessor.prepare_annotation
    ...
    # Copied from transformers_471.models.detr.image_processing_detr.DetrImageProcessor.post_process  with Detr->Yolos
    ...
    # Copied from transformers_471.models.detr.image_processing_detr.DetrImageProcessor.post_process_object_detection with Detr->Yolos
