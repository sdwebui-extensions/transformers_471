...
class ClapTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_471 import ClapTextConfig, ClapTextModel
...
class ClapAudioConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_471 import ClapAudioConfig, ClapAudioModel
...
class ClapConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_471 import ClapConfig, ClapModel
    ...
    >>> from transformers_471 import ClapTextConfig, ClapAudioConfig
