...
class XLMRobertaConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_471 import XLMRobertaConfig, XLMRobertaModel
...
# Copied from transformers_471.models.roberta.configuration_roberta.RobertaOnnxConfig with Roberta->XLMRoberta
