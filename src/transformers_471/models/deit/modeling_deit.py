...
# Copied from transformers_471.models.vit.modeling_vit.ViTSelfAttention with ViT->DeiT
...
# Copied from transformers_471.models.vit.modeling_vit.ViTSelfOutput with ViT->DeiT
...
# Copied from transformers_471.models.vit.modeling_vit.ViTAttention with ViT->DeiT
...
# Copied from transformers_471.models.vit.modeling_vit.ViTIntermediate with ViT->DeiT
...
# Copied from transformers_471.models.vit.modeling_vit.ViTOutput with ViT->DeiT
...
# Copied from transformers_471.models.vit.modeling_vit.ViTLayer with ViT->DeiT,VIT->DEIT
...
# Copied from transformers_471.models.vit.modeling_vit.ViTEncoder with ViT->DeiT
...
# Copied from transformers_471.models.vit.modeling_vit.ViTPooler with ViT->DeiT
...
class DeiTForMaskedImageModeling(DeiTPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        Examples:
        ```python
        >>> from transformers_471 import AutoImageProcessor, DeiTForMaskedImageModeling
        >>> import torch
...
class DeiTForImageClassification(DeiTPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        ```python
        >>> from transformers_471 import AutoImageProcessor, DeiTForImageClassification
        >>> import torch
        >>> from PIL import Image
        >>> import requests
