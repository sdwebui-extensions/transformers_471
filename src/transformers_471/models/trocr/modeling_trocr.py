...
# Copied from transformers_471.models.bart.modeling_bart.BartLearnedPositionalEmbedding with Bart->TrOCR
...
# Copied from transformers_471.models.bart.modeling_bart.BartScaledWordEmbedding with Bart->TrOCR
