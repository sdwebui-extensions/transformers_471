...
# Copied from transformers_471.models.longformer.modeling_tf_longformer.TFLongformerSelfAttention with TFLongformer->TFLEDEncoder
...
@dataclass
# Copied from transformers_471.models.longformer.modeling_tf_longformer.TFLongformerBaseModelOutput with TFLongformer->TFLEDEncoder
...
class TFLEDForConditionalGeneration(TFLEDPreTrainedModel):
    ...
    def call(
        ...
        ```python
        >>> from transformers_471 import AutoTokenizer, TFLEDForConditionalGeneration
        >>> import tensorflow as tf
