...
# Copied from transformers_471.models.bart.modeling_tf_bart.TFBartAttention with Bart->Marian
...
# Copied from transformers_471.models.bart.modeling_tf_bart.TFBartEncoderLayer with Bart->Marian
...
# Copied from transformers_471.models.bart.modeling_tf_bart.TFBartDecoderLayer with Bart->Marian
...
MARIAN_GENERATION_EXAMPLE = r"""
        ...
        ```python
        >>> from transformers_471 import AutoTokenizer, TFMarianMTModel
