...
class MllamaVisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_471 import MllamaVisionConfig, MllamaVisionModel
...
class MllamaTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_471 import MllamaTextModel, MllamaTextConfig
...
class MllamaConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_471 import MllamaForConditionalGeneration, MllamaConfig, MllamaVisionConfig, MllamaTextConfig
