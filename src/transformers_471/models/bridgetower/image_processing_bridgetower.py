...
# Copied from transformers_471.models.vilt.image_processing_vilt.get_resize_output_image_size
...
class BridgeTowerImageProcessor(BaseImageProcessor):
    ...
    # Copied from transformers_471.models.vilt.image_processing_vilt.ViltImageProcessor.resize
    def resize(
        self,
        image: np.ndarray,
        size: dict[str, int],
