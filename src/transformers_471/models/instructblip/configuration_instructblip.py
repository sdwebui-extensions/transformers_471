...
class InstructBlipVisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_471 import InstructBlipVisionConfig, InstructBlipVisionModel
...
class InstructBlipQFormerConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_471 import InstructBlipQFormerConfig, InstructBlipQFormerModel
