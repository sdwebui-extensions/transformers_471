...
# Copied from transformers_471.models.llama.modeling_llama.LlamaRotaryEmbedding with Llama->Falcon
...
# Copied from transformers_471.models.bloom.modeling_bloom.dropout_add
...
class FalconAttention(nn.Module):
    ...
    # Copied from transformers_471.models.bloom.modeling_bloom.BloomAttention._merge_heads
...
class FalconPreTrainedModel(PreTrainedModel):
    ...
    # Adapted from transformers_471.modeling_utils.PreTrainedModel._check_and_enable_sdpa
    @classmethod
