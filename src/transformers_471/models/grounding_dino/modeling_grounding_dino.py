...
# Copied from transformers_471.models.detr.modeling_detr.DetrFrozenBatchNorm2d with Detr->GroundingDino
...
# Copied from transformers_471.models.detr.modeling_detr.replace_batch_norm with Detr->GroundingDino
...
class GroundingDinoConvEncoder(nn.Module):
    ...
    # Copied from transformers_471.models.detr.modeling_detr.DetrConvEncoder.forward with Detr->GroundingDino
...
# Copied from transformers_471.models.detr.modeling_detr.DetrConvModel with Detr->GroundingDino
...
# Copied from transformers_471.models.deformable_detr.modeling_deformable_detr.DeformableDetrMultiscaleDeformableAttention with DeformableDetr->GroundingDino, Deformable DETR->Grounding DINO
...
# Copied from transformers_471.models.beit.modeling_beit.BeitDropPath with Beit->GroundingDino
