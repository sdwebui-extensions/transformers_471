...
# Copied from transformers_471.models.detr.image_processing_detr.prepare_coco_detection_annotation with DETR->GroundingDino
...
# Copied from transformers_471.models.detr.image_processing_detr.prepare_coco_panoptic_annotation with DETR->GroundingDino
...
# Copied from transformers_471.models.detr.image_processing_detr.post_process_panoptic_sample
...
# Copied from transformers_471.models.owlvit.image_processing_owlvit._scale_boxes
...
class GroundingDinoImageProcessor(BaseImageProcessor):
    ...
    @classmethod
    # Copied from transformers_471.models.detr.image_processing_detr.DetrImageProcessor.from_dict with Detr->GroundingDino
    ...
    # Copied from transformers_471.models.detr.image_processing_detr.DetrImageProcessor.prepare_annotation with DETR->GroundingDino
    ...
    # Copied from transformers_471.models.owlvit.image_processing_owlvit.OwlViTImageProcessor.post_process_object_detection with OwlViT->GroundingDino
