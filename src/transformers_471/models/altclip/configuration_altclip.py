...
class AltCLIPTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_471 import AltCLIPTextModel, AltCLIPTextConfig
...
class AltCLIPVisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_471 import AltCLIPVisionConfig, AltCLIPVisionModel
...
class AltCLIPConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_471 import AltCLIPConfig, AltCLIPModel
