...
class MobileBertConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_471 import MobileBertConfig, MobileBertModel
...
# Copied from transformers_471.models.bert.configuration_bert.BertOnnxConfig with Bert->MobileBert
