...
class FlavaImageConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_471 import FlavaImageConfig, FlavaImageModel
...
class FlavaTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_471 import FlavaTextConfig, FlavaTextModel
...
class FlavaMultimodalConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_471 import FlavaMultimodalConfig, FlavaMultimodalModel
...
class FlavaImageCodebookConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_471 import FlavaImageCodebookConfig, FlavaImageCodebook
...
class FlavaConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_471 import FlavaConfig, FlavaModel, FlavaForPreTraining
