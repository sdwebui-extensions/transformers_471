...
# Copied from transformers_471.models.convnext.modeling_convnext.drop_path
...
# Copied from transformers_471.models.beit.modeling_beit.BeitDropPath with Beit->Bit
