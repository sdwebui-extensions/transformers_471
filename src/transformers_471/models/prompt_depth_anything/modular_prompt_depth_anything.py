...
from transformers_471.models.depth_anything.configuration_depth_anything import DepthAnythingConfig
from transformers_471.models.depth_anything.modeling_depth_anything import (
