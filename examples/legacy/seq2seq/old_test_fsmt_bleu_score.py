...
from transformers_471 import FSMTForConditionalGeneration, FSMTTokenizer
from transformers_471.testing_utils import get_tests_dir, require_torch, slow, torch_device
