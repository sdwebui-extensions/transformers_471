...
from transformers_471.integrations import is_deepspeed_zero3_enabled
...
def main():
    ...
    tok_logger = transformers_471.utils.logging.get_logger("transformers_471.tokenization_utils_base")
